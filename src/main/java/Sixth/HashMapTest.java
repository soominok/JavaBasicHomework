...
public class HashMapTest {
    ...
    public static void main(String[] args) {
        ...
        // 맵을 사용할 때는 앞쪽에 키로 올 정보
        // 뒤쪽은  value로 사용할 정보
        // 모든 것을 다 받겠다 하면 object
        // 보통 키값은 Integer, String을 많이 씀

        // Person class를 만들어서 Map에 넣은 것.
        Map<Integer, Person> p = new HashMap<Integer, Person>();


        for(int i = START; i < MAX; i++) {
            // putdms HashMap에 정보를 삽입하는 매서
            p.put(i, new Person(rand.nextInt(RANGE) + BIAS, randName()));
        ...
        // put()을 통해서 데이터 교체가 가능하다
        p.put(3, new Person(3, "안녕"));
        System.out.println(p);

        // 키 값과, 밸류 값 분류하기
        // Map.Entry를 사용하여 실제 HashMap에 있는 정보들 중
        // 한개씩 얻어올 수 있다.
